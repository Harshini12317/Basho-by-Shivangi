  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Back to Dashboard Button - Above Heading */}
        <div className="mb-6">
          <button
            onClick={() => router.push("/admin/dashboard")}
            className="flex items-center gap-2 px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 font-semibold transition-colors mb-4"
          >
            ← Back to Dashboard
          </button>
          <h1 className="text-3xl font-bold">Home Page Image Management</h1>
          <p className="text-gray-600">Upload and manage images for different sections of your homepage</p>
        </div>
        ...
        {/* Section Tabs */}
        <div className="flex gap-4 mb-8 border-b bg-white rounded-t-lg shadow mt-8">
          {(
            [
              "heroSlideshow",
              "gsapSlider",
